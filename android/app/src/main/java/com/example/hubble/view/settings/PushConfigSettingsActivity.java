...
import com.example.hubble.databinding.ActivityPushConfigSettingsBinding;
...
public class PushConfigSettingsActivity extends BaseAuthActivity {

    private ActivityPushConfigSettingsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPushConfigSettingsBinding.inflate(getLayoutInflater());
