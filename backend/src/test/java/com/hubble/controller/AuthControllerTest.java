...
//                    .thenReturn("Vui lòng kiểm tra email để nhận mã OTP xác thực.");
//
...
//            LoginRequest request = LoginRequest.builder().email("giahuy@example.com").password("").build();
//            mockMvc.perform(post("/api/auth/login")
//                            .contentType(MediaType.APPLICATION_JSON)
//                            .content(asJson(request)))
//                    .andExpect(status().is4xxClientError());
...
//            GoogleLoginRequest request = GoogleLoginRequest.builder().idToken("invalid-token").build();
...
//            PhoneSendOtpRequest request = PhoneSendOtpRequest.builder().phone("invalid").build();
//
//            mockMvc.perform(post("/api/auth/phone/send-otp")
//                            .contentType(MediaType.APPLICATION_JSON)
//                            .content(asJson(request)))
...
//            PhoneSendOtpRequest request = PhoneSendOtpRequest.builder().phone("9999999999").build();
...
//            ForgotPasswordRequest request = ForgotPasswordRequest.builder().email("nonexistent@example.com").build();
//            doThrow(new AppException(ErrorCode.USER_NOT_EXISTED))
